...
//  KlickMichWeg
//
//  Created by Julia on 07.08.24.
//

import SwiftUI

struct HomeListItemView: View {
    @StateObject var viewModel = HomeListItemViewModel()
    let item:ListItems
...
#Preview {
    HomeListItemView(item: .init(id: "0123", title: "Melanie anrufen", date: Date().timeIntervalSince1970, createdDate: Date().timeIntervalSince1970, notiz: "Besprechung nächste Marketingaktion", isDone: false))
}
